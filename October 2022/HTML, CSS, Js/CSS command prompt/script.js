...
cli.on("^platform\s?$", function(output) {
  ...
  output.puts("Screen Resolution: " + window.screen.width + " x " + window.screen.height);
  output.puts("Screen Color Depth: " + window.screen.pixelDepth + " bits per pixel");
});

cli.on("^date\s?$", function(output) {
  var d = new Date();
  var days = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
  var months = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
  output.puts("Current date is: " + days[d.getDay()] + " " + d.getDate() + " " + months[d.getMonth()] + " " + d.getFullYear());
});

cli.on("^ip\s?$", function(output) {
  $(function() {
